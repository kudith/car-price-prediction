...
- colab/: Contains the Jupyter Notebook (car-sales.ipynb) used for Exploratory Data Analysis (EDA), feature engineering, and model training.
...
1. Data Science Workflow: See colab/car-sales.ipynb for the model development process.
